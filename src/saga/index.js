...
import { AUTH_USER, CREATE_CLAIM, FETCH_CLIENTS, SIGNUP_USER, SEARCH_TEXT, UPLOAD_FILE } from '../actions/types';
import { signInUserSaga, signUpUserSaga } from './auth';
import { addClaimSaga, fetchClientsSaga, searchSaga, uploadDataSaga } from './claim'
...
export default function* rootSaga() {
	...
	yield takeEvery(UPLOAD_FILE, uploadDataSaga)
}
